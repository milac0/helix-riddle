...
const iv = cryptedPdf.slice(0, 15)
const decipher = crypto.createDecipheriv('aes-256-ecb', keyBuff, iv)
const decryptedPdf  = Buffer.concat([crypto.update(cryptedPdf.slice(16)), decipher.final()])
